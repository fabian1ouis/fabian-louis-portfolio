                ...
                <CardContent className="p-0">
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-3 pt-2">
                      ...
                      >
                        <a href="https://github.com/09c011ab0/catchupwithfab" target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="p-6 space-y-4">
                    ...
                    <div className="flex gap-3 pt-2">
                      ...
                      <Button
                        ...
                        className="flex-1 border-border hover:border-primary/50 hover:text-primary"
                      >
                        <a href="https://github.com/09c011ab0/earlykickoffwithfab" target="_blank" rel="noopener noreferrer">
                          <Github className="w-4 h-4 mr-2" />
                          View Code
                        </a>
                      </Button>
